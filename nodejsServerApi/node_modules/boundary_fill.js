...
class Point {
    ...
    manhattanDistance(other) {
        return new Promise(resolve => {
            resolve(abs(this.x - other.x) + abs(this.y - other.y));
        });
    }
}
...
class Player {
    ...
    fillBetween(prevPos, currPos) {
        ...
        while (prevPos.manhattanDistance(curr) <= prevPos.manhattanDistance(currPos)) {
            console.log(prevPos.manhattanDistance(curr), prevPos.manhattanDistance(currPos));
