...
class Arena {
    constructor(name, _upperLeftCorner, _lowerRightCorner, _latitudeGridUnitCount) {
        this.players = new Map(); // playerid player map
        this.name = name;
        this.fields = [];
        this.upperLeftCorner = _upperLeftCorner;
        this.lowerRightCorner = _lowerRightCorner;
        ...
        setInterval(this.sendDataToPlayers, 100);
    }
